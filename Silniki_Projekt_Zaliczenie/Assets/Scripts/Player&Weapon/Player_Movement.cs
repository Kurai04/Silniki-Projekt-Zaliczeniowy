...
public class Player_Movement : MonoBehaviour
{
    ...
    private void Move(float _speed, float _maxSpeed)
    {
        ...
        //Ograniczenie zmian szybko�ci na gracza kiedy jest w powietrzu
        ...
        rigidBody.velocity = new Vector2(Mathf.Clamp(rigidBody.velocity.x, -_maxSpeed, _maxSpeed), rigidBody.velocity.y);
            //Je�li chce zmieni� kierunek ruchu dodajemy odwrotn� pr�dko�� do gracza �eby j� wyzerowa� i wtedy pozosta�a pr�dko�� jest dodana jak w przypadku kiedy zacz�li�my stacjonarnie
